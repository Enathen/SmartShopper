...
public class googleMapsShops extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected LatLng mDefaultLocation;
  ...
  /*      mGeoDataClient = Places.getGeoDataClient(this, null);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("UMEÅ BROOOR").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)));
