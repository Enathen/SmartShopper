...
public class googleMapsShops extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(63.79968 , 20.34160);
        mMap.addMarker(new MarkerOptions().position(sydney).title("UMEÅ BROOOR").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ROSE)));
